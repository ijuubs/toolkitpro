...
export default function DisclaimerPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tighter border-b-4 sm:border-b-8 border-black pb-3 sm:pb-4 leading-tight">Disclaimer</h1>
      ...
      <div className="prose prose-lg max-w-none text-[var(--muted)] space-y-4 sm:space-y-6 text-sm sm:text-base leading-relaxed">
        ...
        <h2 className="text-xl sm:text-2xl font-black text-black uppercase pt-2">Disclaimers for ToolKitPro</h2>
        ...
        <h2 className="text-xl sm:text-2xl font-black text-black uppercase pt-2">External Links Disclaimer</h2>
        <p>From our website, you can visit other websites by following hyperlinks to such external sites. While we strive to provide only quality links to useful and ethical websites, we have no control over the content and nature of these sites. These links to other websites do not imply a recommendation for all the content found on these sites. Site owners and content may change without notice and may occur before we have the opportunity to remove a link which may have gone 'bad'.</p>

        <h3 className="text-lg sm:text-xl font-bold text-black uppercase pt-2">Consent</h3>
        <p>By using our website, you hereby consent to our disclaimer and agree to its terms.</p>

        <h3 className="text-lg sm:text-xl font-bold text-black uppercase pt-2">Update</h3>
